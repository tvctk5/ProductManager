...
{
    [ModuleInfo(Name = "MO :[Sản phẩm] Nhóm khách hàng", Code = "MProduct_CustomersGroups", Order = 50)]
    public class MProduct_CustomersGroupsController : Controller
    {

        [VSW.Core.MVC.PropertyInfo("Số lượng")]
        public int PageSize = 10;

        public void ActionIndex(MProduct_CustomersGroupsModel model)
        {
    ...
    public class MProduct_CustomersGroupsModel
    {
        private int _Page = 0;
        public int Page
        {
