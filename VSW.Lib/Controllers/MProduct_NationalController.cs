...
{
    [ModuleInfo(Name = "MO : Product_ national", Code = "MProduct_National", Order = 50)]
    public class MProduct_NationalController : Controller
    {

        [VSW.Core.MVC.PropertyInfo("Số lượng")]
        public int PageSize = 10;

        public void ActionIndex(MProduct_NationalModel model)
        {
        ...
        {
            var item = ModProduct_NationalService.Instance.CreateQuery()
                            .Where(o => o.Activity == true && o.Code == endCode)
                            .ToSingle();

            if (item != null)
            {
                ViewBag.Other = ModProduct_NationalService.Instance.CreateQuery()
                                        .Where(o => o.Activity == true)
    ...
    public class MProduct_NationalModel
    {
        private int _Page = 0;
        public int Page
        {
