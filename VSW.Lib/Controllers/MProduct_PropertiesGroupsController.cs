...
{
    [ModuleInfo(Name = "MO : Product_ properties groups", Code = "MProduct_PropertiesGroups", Order = 50)]
    public class MProduct_PropertiesGroupsController : Controller
    {

        [VSW.Core.MVC.PropertyInfo("Số lượng")]
        public int PageSize = 10;

        public void ActionIndex(MProduct_PropertiesGroupsModel model)
        {
        ...
        {
            var item = ModProduct_PropertiesGroupsService.Instance.CreateQuery()
                            .Where(o => o.Activity == true && o.Code == endCode)
                            .ToSingle();

            if (item != null)
            {
                ViewBag.Other = ModProduct_PropertiesGroupsService.Instance.CreateQuery()
                                        .Where(o => o.Activity == true)
    ...
    public class MProduct_PropertiesGroupsModel
    {
        private int _Page = 0;
        public int Page
        {
