...
{
    [ModuleInfo(Name = "MO : Product_ office", Code = "MProduct_Office", Order = 50)]
    public class MProduct_OfficeController : Controller
    {

        [VSW.Core.MVC.PropertyInfo("Số lượng")]
        public int PageSize = 10;

        public void ActionIndex(MProduct_OfficeModel model)
        {
        ...
        {
            var item = ModProduct_OfficeService.Instance.CreateQuery()
                            .Where(o => o.Activity == true && o.Code == endCode)
                            .ToSingle();

            if (item != null)
            {
                ViewBag.Other = ModProduct_OfficeService.Instance.CreateQuery()
                                        .Where(o => o.Activity == true)
    ...
    public class MProduct_OfficeModel
    {
        private int _Page = 0;
        public int Page
        {
