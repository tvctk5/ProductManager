...
{
    [ModuleInfo(Name = "MO : Product_ supplier", Code = "MProduct_Supplier", Order = 50)]
    public class MProduct_SupplierController : Controller
    {

        [VSW.Core.MVC.PropertyInfo("Số lượng")]
        public int PageSize = 10;

        public void ActionIndex(MProduct_SupplierModel model)
        {
        ...
        {
            var item = ModProduct_SupplierService.Instance.CreateQuery()
                            .Where(o => o.Activity == true && o.Code == endCode)
                            .ToSingle();

            if (item != null)
            {
                ViewBag.Other = ModProduct_SupplierService.Instance.CreateQuery()
                                        .Where(o => o.Activity == true)
    ...
    public class MProduct_SupplierModel
    {
        private int _Page = 0;
        public int Page
        {
