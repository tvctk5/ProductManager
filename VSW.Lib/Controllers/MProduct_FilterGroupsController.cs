...
{
    [ModuleInfo(Name = "MO : Product_ filter groups", Code = "MProduct_FilterGroups", Order = 50)]
    public class MProduct_FilterGroupsController : Controller
    {

        [VSW.Core.MVC.PropertyInfo("Số lượng")]
        public int PageSize = 10;

        public void ActionIndex(MProduct_FilterGroupsModel model)
        {
        ...
        {
            var item = ModProduct_FilterGroupsService.Instance.CreateQuery()
                            .Where(o => o.Activity == true && o.Code == endCode)
                            .ToSingle();

            if (item != null)
            {
                ViewBag.Other = ModProduct_FilterGroupsService.Instance.CreateQuery()
                                        .Where(o => o.Activity == true)
    ...
    public class MProduct_FilterGroupsModel
    {
        private int _Page = 0;
        public int Page
        {
