...
{
    [ModuleInfo(Name = "MO : Province", Code = "MProvince", Order = 50)]
    public class MProvinceController : Controller
    {
        ...
        public void ActionIndex(MProvinceModel model)
        {
        ...
        {
            var item = ModProvinceService.Instance.CreateQuery()
                            .Where(o => o.Activity == true && o.Code == endCode)
                            .ToSingle();

            if (item != null)
            {
                ViewBag.Other = ModProvinceService.Instance.CreateQuery()
                                        .Where(o => o.Activity == true)
