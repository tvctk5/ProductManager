...
{
    [ModuleInfo(Name = "MO : Product_ manufacturer", Code = "MProduct_Manufacturer", Order = 50)]
    public class MProduct_ManufacturerController : Controller
    {

        [VSW.Core.MVC.PropertyInfo("Số lượng")]
        public int PageSize = 10;

        public void ActionIndex(MProduct_ManufacturerModel model)
        {
        ...
        {
            var item = ModProduct_ManufacturerService.Instance.CreateQuery()
                            .Where(o => o.Activity == true && o.Code == endCode)
                            .ToSingle();

            if (item != null)
            {
                ViewBag.Other = ModProduct_ManufacturerService.Instance.CreateQuery()
                                        .Where(o => o.Activity == true)
    ...
    public class MProduct_ManufacturerModel
    {
        private int _Page = 0;
        public int Page
        {
