...
{
    [ModuleInfo(Name = "MO : Nước", Code = "MCountry", Order = 50)]
    public class MCountryController : Controller
    {
        ...
        public void ActionIndex(MCountryModel model)
        {
        ...
        {
            var item = ModCountryService.Instance.CreateQuery()
                            .Where(o => o.Activity == true && o.Code == endCode)
                            .ToSingle();

            if (item != null)
            {
                ViewBag.Other = ModCountryService.Instance.CreateQuery()
                                        .Where(o => o.Activity == true)
