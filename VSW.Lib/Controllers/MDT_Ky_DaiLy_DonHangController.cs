...
{
    [ModuleInfo(Name = "MO : D t_ ky_ dai ly_ don hang", Code = "MDT_Ky_DaiLy_DonHang", Order = 50)]
    public class MDT_Ky_DaiLy_DonHangController : Controller
    {

        [VSW.Core.MVC.PropertyInfo("Số lượng")]
        public int PageSize = 10;

        public void ActionIndex(MDT_Ky_DaiLy_DonHangModel model)
        {
        ...
        {
            var item = ModDT_Ky_DaiLy_DonHangService.Instance.CreateQuery()
                            .Where(o => o.Activity == true && o.Code == endCode)
                            .ToSingle();

            if (item != null)
            {
                ViewBag.Other = ModDT_Ky_DaiLy_DonHangService.Instance.CreateQuery()
                                        .Where(o => o.Activity == true)
    ...
    public class MDT_Ky_DaiLy_DonHangModel
    {
        private int _Page = 0;
        public int Page
        {
