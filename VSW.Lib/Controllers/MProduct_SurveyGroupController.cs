...
{
    [ModuleInfo(Name = "MO : Product_ survey group", Code = "MProduct_SurveyGroup", Order = 50)]
    public class MProduct_SurveyGroupController : Controller
    {

        [VSW.Core.MVC.PropertyInfo("Số lượng")]
        public int PageSize = 10;

        public void ActionIndex(MProduct_SurveyGroupModel model)
        {
        ...
        {
            var item = ModProduct_SurveyGroupService.Instance.CreateQuery()
                            .Where(o => o.Activity == true && o.Code == endCode)
                            .ToSingle();

            if (item != null)
            {
                ViewBag.Other = ModProduct_SurveyGroupService.Instance.CreateQuery()
                                        .Where(o => o.Activity == true)
    ...
    public class MProduct_SurveyGroupModel
    {
        private int _Page = 0;
        public int Page
        {
