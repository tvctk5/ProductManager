...
{
    [ModuleInfo(Name = "MO : Product_ national_ area", Code = "MProduct_National_Area", Order = 50)]
    public class MProduct_National_AreaController : Controller
    {

        [VSW.Core.MVC.PropertyInfo("Số lượng")]
        public int PageSize = 10;

        public void ActionIndex(MProduct_National_AreaModel model)
        {
        ...
        {
            var item = ModProduct_National_AreaService.Instance.CreateQuery()
                            .Where(o => o.Activity == true && o.Code == endCode)
                            .ToSingle();

            if (item != null)
            {
                ViewBag.Other = ModProduct_National_AreaService.Instance.CreateQuery()
                                        .Where(o => o.Activity == true)
    ...
    public class MProduct_National_AreaModel
    {
        private int _Page = 0;
        public int Page
        {
