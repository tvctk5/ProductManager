...
{
    [ModuleInfo(Name = "MO : Product_ agent", Code = "MProduct_Agent", Order = 50)]
    public class MProduct_AgentController : Controller
    {

        [VSW.Core.MVC.PropertyInfo("Số lượng")]
        public int PageSize = 10;

        public void ActionIndex(MProduct_AgentModel model)
        {
        ...
        {
            var item = ModProduct_AgentService.Instance.CreateQuery()
                            .Where(o => o.Activity == true && o.Code == endCode)
                            .ToSingle();

            if (item != null)
            {
                ViewBag.Other = ModProduct_AgentService.Instance.CreateQuery()
                                        .Where(o => o.Activity == true)
    ...
    public class MProduct_AgentModel
    {
        private int _Page = 0;
        public int Page
        {
