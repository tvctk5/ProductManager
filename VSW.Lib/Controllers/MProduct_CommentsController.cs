...
{
    [ModuleInfo(Name = "MO : Product_ comments", Code = "MProduct_Comments", Order = 50)]
    public class MProduct_CommentsController : Controller
    {

        [VSW.Core.MVC.PropertyInfo("Số lượng")]
        public int PageSize = 10;

        public void ActionIndex(MProduct_CommentsModel model)
        {
        ...
        {
            var item = ModProduct_CommentsService.Instance.CreateQuery()
                            .Where(o => o.Activity == true && o.ID == id)
                            .ToSingle();

            if (item != null)
            {
                ViewBag.Other = ModProduct_CommentsService.Instance.CreateQuery()
                                        .Where(o => o.Activity == true)
    ...
    public class MProduct_CommentsModel
    {
        private int _Page = 0;
        public int Page
        {
