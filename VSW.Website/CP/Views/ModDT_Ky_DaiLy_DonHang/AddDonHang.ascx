...
<input type="hidden" id="ModDTKyDaiLyId" name="ModDTKyDaiLyId" value="<%=model.ModDTKyDaiLyId %>" />
<input type="hidden" id="ModDtKyId" name="ModDtKyId" value="<%=model.ModDtKyId %>" />
        ...
        <div class="col width-100">
            <table class="admintable">
                <tr>
                    ...
                    <td>
                        <input class="text_input" type="text" name="Ky" value="<%=Ky.Name %>" readonly="readonly" />
                    </td>
                </tr>
                <tr>
                    <td class="key">
