...
<%
    ...
    var listItem = ViewBag.Data as List<ModProduct_National_AreaEntity>;
%>
...
<script type="text/javascript">
    ...
    var VSWController = 'ModProduct_National_Area';
        ...
        <table class="adminlist" cellspacing="1">
            <thead>
                <tr>
                    ...
                    <th width="1%" nowrap="nowrap">
                        <%= GetSortLink("Product national id", "ProductNationalId")%>
                    </th>
                    <th width="1%" nowrap="nowrap">
                        <%= GetSortLink("Mã", "Code")%>
                    </th>
            ...
            <tbody>
               <%for (int i = 0; listItem != null && i < listItem.Count; i++)
                ...
                <tr class="row<%= i%2 %>">
                    ...
                    <td align="center">
                       <%= string.Format("{0:#,##0}", listItem[i].ProductNationalId)%>
                    </td>
                    <td align="center">
                       <%= listItem[i].Code%>
                    </td>
