...
<%
    ...
    var listItem = ViewBag.Data as List<ModProduct_CustomersGroupsEntity>;
%>
...
<script type="text/javascript">
    ...
    var VSWController = 'ModProduct_CustomersGroups';
            ...
            <thead>
                <tr>
                    ...
                    <th width="10%" nowrap="nowrap">
                        <%= GetSortLink("Mã nhóm", "Code")%>
                    </th>
                    <th class="title">
                        <%= GetSortLink("Tên", "Name")%>
                    </th>
                    <th width="10%" nowrap="nowrap">
                        <%= GetSortLink("Điểm bắt đầu", "PointStart")%>
                    </th>
                    <th width="10%" nowrap="nowrap">
                        <%= GetSortLink("Điểm kết thúc", "PointEnd")%>
                    </th>
                    <th width="10%" nowrap="nowrap">
