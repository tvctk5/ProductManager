...
<script type="text/javascript">
    ...
    var VSWController = 'ModProduct_Customers';
            ...
            <thead>
                <tr>
                    ...
                    <th width="20%" nowrap="nowrap">
                        <%= GetSortLink("Tài khoản", "UserName")%>
                    </th>
                    <th nowrap="nowrap">
                        <%= GetSortLink("Họ và tên", "FullName")%>
                    </th>
                    <th width="5%" nowrap="nowrap">
                    ...
                    <th width="5%" nowrap="nowrap">
                        <%= GetSortLink("Tổng điểm", "PointTotal")%>
                    </th>
                    <th width="10%" nowrap="nowrap">
                ...
                <tr class="row<%= i%2 %>">
                    ...
                    <td align="left">
                        <a href="javascript:VSWRedirect('Add', <%= listItem[i].ID %>)">
                            <%= listItem[i].UserName%></a>
                    </td>
                    <td align="left">
                        <a href="javascript:VSWRedirect('Add', <%= listItem[i].ID %>)">
                            <%= listItem[i].FullName%></a>
                    </td>
                    <td align="center">
                        <%= listItem[i].Sex?"Nữ" : "Nam"%>
                    </td>
                    <td align="center">
                        <%= listItem[i].PhoneNumber%>
                    </td>
                    <td align="right">
                        <%= string.Format("{0:#,##0}", listItem[i].PointTotal)%>
                    </td>
                    <td align="center">
