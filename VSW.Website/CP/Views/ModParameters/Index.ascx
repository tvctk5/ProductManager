...
<%
    ...
    var listItem = ViewBag.Data as List<ModParametersEntity>;
%>
...
<script type="text/javascript">
    ...
    var VSWController = 'ModParameters';
        ...
        <table class="adminlist" cellspacing="1">
            <thead>
                <tr>
                    ...
                    <th width="1%" nowrap="nowrap">
                        <%= GetSortLink("Description", "Description")%>
                    </th>
                    <th width="1%" nowrap="nowrap">
            ...
            <tbody>
               <%for (int i = 0; listItem != null && i < listItem.Count; i++)
                ...
                <tr class="row<%= i%2 %>">
                    ...
                    <td align="center">
                       <%= string.Format("{0:dd/MM/yyyy HH:mm}", listItem[i].Modified) %>
                    </td>
                </tr>
                <%} %>
            </tbody>
