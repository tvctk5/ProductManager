...
<%
    ...
    var listItem = ViewBag.Data as List<ModWardEntity>;
%>
        ...
        <table class="adminlist" cellspacing="1">
            <thead>
                <tr>
                    ...
                    <th width="1%" nowrap="nowrap">
                        <%= GetSortLink("Quận huyện", "DistrictFullName")%>
                    </th>
                    <th width="1%" nowrap="nowrap">
                        <%= GetSortLink("Mã", "Code")%>
                    </th>
                    ...
                    <th width="1%" nowrap="nowrap">
                        <%= GetSortLink("Tên đầy đủ", "FullName")%>
                    </th>
                    <th width="1%" nowrap="nowrap">
                        <%= GetSortLink("Location", "Location")%>
                    </th>
                    <th width="1%" nowrap="nowrap">
