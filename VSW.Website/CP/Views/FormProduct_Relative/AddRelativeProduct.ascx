...
<script language="javascript" type="text/javascript">
    ...
    var urlProduct_Add = '<%=ResolveUrl("~/CP/Tools/Ajax/ModProduct_Info/PostData.aspx?Type=relativeAdd&GetList=TRUE")%>';
    var urlProduct_Delete = '<%=ResolveUrl("~/CP/Tools/Ajax/ModProduct_Info/PostData.aspx?Type=relativeDelete&GetList=TRUE")%>';
...
<script type="text/javascript">
    ...
    var VSWController = 'FormProduct_Relative';
            ...
            <table class="adminlist" cellspacing="1">
                ...
                <tbody style="width: 100% !important;">
                    ...
                    <tr class="row<%= i%2 %>">
                        ...
                        <td align="right" nowrap="nowrap">
                            <%= string.Format("{0:#,##0}", listProduct_LienQuan[i].Price)%>
                        </td>
                        <td align="left">
                        ...
                        <td align="center">
                            <a class="jgrid Add <%=FormProduct_RelativeController.CheckExisted(ProductCurrent.ProductsConnection,listProduct_LienQuan[i].ID)?"a-hide":"" %>"
                                title="Thêm sản phẩm liên quan" href="javascript:void(0);" onclick="RelativeAdd(urlProduct_Add,this,'<%=listProduct_LienQuan[i].ID %>',true);return false;">
                                <span class="jgrid"><span class="state add"></span></span></a>
                        </td>
                        <td align="center">
                            <a class="jgrid Delete <%=FormProduct_RelativeController.CheckExisted(ProductCurrent.ProductsConnection,listProduct_LienQuan[i].ID)?"":"a-hide" %>"
                                title="Xóa sản phẩm liên quan" href="javascript:void(0);" onclick="RelativeDelete(urlProduct_Delete,this,'<%=listProduct_LienQuan[i].ID %>',true);return false;">
