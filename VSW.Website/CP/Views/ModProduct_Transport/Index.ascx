...
<%
    var model = ViewBag.Model as ModProduct_TransportModel;
    var listItem = ViewBag.Data as List<ModProduct_TransportEntity>;
%>
...
<div id="toolbar-box">
    ...
    <div class="m">
        ...
        <div class="pagetitle icon-48-generic">
            <h2>
                Hình thức vận chuyển: Danh sách</h2>
        </div>
        <div class="clr">
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var VSWController = 'ModProduct_Transport';
        ...
        <table class="adminlist" cellspacing="1">
            <thead>
                <tr>
                    ...
                    <th class="title">
                        <%= GetSortLink("Tên hình thức", "Name")%>
                    </th>
