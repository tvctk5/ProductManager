...
<%
    var model = ViewBag.Model as ModProduct_TypesModel;
    var listItem = ViewBag.Data as List<ModProduct_TypesEntity>;
%>
...
<script type="text/javascript">
    ...
    var VSWController = 'ModProduct_Types';
