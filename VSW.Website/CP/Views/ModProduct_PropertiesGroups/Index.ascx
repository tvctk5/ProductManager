...
<%
    ...
    var listItem = ViewBag.Data as List<ModProduct_PropertiesGroupsEntity>;
%>
...
<script type="text/javascript">
    ...
    var VSWController = 'ModProduct_PropertiesGroups';
            ...
            <thead>
                <tr>
                    ...
                    <th width="20%" nowrap="nowrap">
                        <%= GetSortLink("Mã nhóm thuộc tính", "Code")%>
                    </th>
                    <th class="title">
                        <%= GetSortLink("Tên nhóm thuộc tính", "Name")%>
                    </th>
                    <th width="20%" nowrap="nowrap">
