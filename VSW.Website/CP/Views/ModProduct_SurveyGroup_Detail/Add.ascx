        ...
        <div class="col width-100">
            <table class="admintable">
                <tr>
                    ...
                    <td>
                        <select name="SurveyGroupId" id="SurveyGroupId" class="DropDownList">
                            <%= Utils.ShowDDLProductSurveyGroups(item.SurveyGroupId)%>
                        </select>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input class="text_input" type="text" name="Vote" id="Vote" value="<%=item.Vote %>"
                            maxlength="255" />
                    </td>
                </tr>
