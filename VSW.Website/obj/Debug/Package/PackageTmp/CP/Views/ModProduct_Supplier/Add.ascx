...
<script language="javascript" type="text/javascript">
    var pageUrl = '<%=ResolveUrl("~/CP/Tools/Ajax/ModProduct_Supplier/PostData.aspx?Type=1")%>';
    var formID = "vswForm";
    ...
    function CheckValidationForm() {
        ...
        if (txtCode != null) {
            if (txtCode.value.trim() != "") {
                if (txtCode.value.trim().length < 3) {
                    Mess = " - Yêu cầu nhập Mã nhà cung cấp từ 3 ký tự trở lên";
                    bolCode = false;
                }
                else {
                    bolCode = true;
                ...
                Mess = " - Yêu cầu nhập Mã nhà cung cấp";
            }
        }
        ...
        if (txtName != null) {
            if (txtName.value.trim() != "") {
                ...
                if (Mess != "")
                { Mess = Mess + "\r\n"; }
                Mess = Mess + " - Yêu cầu nhập Tên nhà cung cấp";
            }
        }
...
<%
    var model = ViewBag.Model as ModProduct_SupplierModel;
    var item = ViewBag.Data as ModProduct_SupplierEntity;
%>
