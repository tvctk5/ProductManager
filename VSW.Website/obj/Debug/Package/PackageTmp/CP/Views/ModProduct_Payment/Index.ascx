...
<%
    ...
    var listItem = ViewBag.Data as List<ModProduct_PaymentEntity>;
%>
...
<div id="toolbar-box">
    ...
    <div class="m">
        ...
        <div class="pagetitle icon-48-generic">
            <h2>
                Hình thức thanh toán: Danh sách</h2>
        </div>
        <div class="clr">
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var VSWController = 'ModProduct_Payment';
        ...
        <table class="adminlist" cellspacing="1">
            <thead>
                <tr>
                    ...
                    <th class="title">
                        <%= GetSortLink("Tên hình thức thanh toán", "Name")%>
                    </th>
