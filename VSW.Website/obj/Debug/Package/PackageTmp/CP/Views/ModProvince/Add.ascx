...
<%
    var model = ViewBag.Model as ModProvinceModel;
...
<div id="toolbar-box">
    ...
    <div class="m">
        ...
        <div class="pagetitle icon-48-generic">
            <h2>Tỉnh thành phố : <%=  model.RecordID > 0 ? "Chỉnh sửa" : "Thêm mới"%></h2>
        </div>
        <div class="clr"></div>
    </div>
        ...
        <div class="col width-100">
          <table class="admintable">
           <tr>
                ...
                <td>
                    <select class="text_input" name="ModCountryId" id="ModCountryId" >
           ...
           <tr>
                ...
                <td>
                    <input class="text_input" type="text" name="Code" id="Code" value="<%=item.Code %>" maxlength="255" readonly="readonly"/>
                </td>
            </tr>
           <tr>
                <td class="key">
