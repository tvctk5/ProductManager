...
<%
    ...
    var listItem = ViewBag.Data as List<ModProduct_SurveyGroupEntity>;
%>
...
<script type="text/javascript">
    ...
    var VSWController = 'ModProduct_SurveyGroup';
        ...
        <table class="adminlist" cellspacing="1">
            ...
            <tbody>
                ...
                <tr class="row<%= i%2 %>">
                    ...
                    <td align="center">
                        <%if (ConvertTool.CheckDateIsNull(listItem[i].StartDate) == false)
                          {%>
                        <%= string.Format("{0:dd/MM/yyyy HH:mm}", listItem[i].StartDate)%>
                        <%} %>
                    </td>
                    <td align="center">
                        <%if (ConvertTool.CheckDateIsNull(listItem[i].FinishDate) == false)
                          {%>
