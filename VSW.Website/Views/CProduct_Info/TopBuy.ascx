...
<%
    ...
    var LinkOnTitle = (int)ViewBag.LinkOnTitle;
    var ShowLinkViewAll = (int)ViewBag.ShowLinkViewAll;
    var ReferentPageId = (int)ViewBag.ReferentPageId;
    ...
    //VSW.Lib.Global.EnumValue percent-sock
...
<div class="box100">
    <div class="DefaultModuleContent">
        <div class="defaultContentTitle TitleContent title">
            <div class="title">
                <%if (ReferentPageId > 0 && LinkOnTitle == (int)EnumValue.LinkOnTitle.TRUE)
                  {%>
                <a href="<%=ViewPage.GetPageURL(ReferentPageId) %>">
                    <%= ViewBag.Title %></a>
                <%}
                  else
                  {%>
        ...
        <div class="defaultContentDetail defaultContent">
            ...
            <%if (ReferentPageId > 0 && ShowLinkViewAll == (int)EnumValue.ShowLinkViewAll.TRUE)
              {%>
            <div class="div-viewall">
                <a href="<%=ViewPage.GetPageURL(ReferentPageId) %>">Xem thêm...</a>
            </div>
            <%}%>
        </div>
