...
<%
    ...
    var Data = ViewBag.Data as List<SysPageEntity>;
    var AllCategory = ViewBag.AllCategory as List<WebMenuEntity>;

    Page = Page == null ? new SysPageEntity() : Page;
    Data = Data == null ? new List<SysPageEntity>() : Data;
    AllCategory = AllCategory == null ? new List<WebMenuEntity>() : AllCategory;
